...
"""
    ...
    parameters {
            ...
            string(name: 'TAG_NAME', defaultValue: 'latest', description: 'TAG_NAME')
            ...
            stage('build')  {
                ...
                steps {
                    script {
                        ...
                        sh """
                        set -x
                        make image-build REPO_HOST=${env.REPO_HOST} TAG=${params.TAG_NAME}
                        """
                    }
                }
            }
            stage('push') {
                ...
                steps {
                    script {
                        ...
                        docker login
                        make image-push REPO_HOST=${env.REPO_HOST} TAG=${params.TAG_NAME}
                        """
                    }
                }
            }
